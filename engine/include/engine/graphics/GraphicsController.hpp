    ...
    */
    ...
    public:
        ...
        */
        ...
        void draw_model(const resources::Model *model, const resources::Shader *shader, const glm::mat4 &modelMatrix,
                        const std::unordered_map<std::string, resources::Texture *> &textures);
